...
## Project Structure
    ...
    ├── testapiautostoryboa_76530  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_76530`
...
2. Clone this repo and `cd testapiautostoryboa_76530`
